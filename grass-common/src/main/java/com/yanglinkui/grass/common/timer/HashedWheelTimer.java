 ...
 * under the License.
 */
package com.yanglinkui.grass.common.timer;
...
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer(
        ...
        Utils.checkNotNull(threadFactory, "threadFactory");
        Utils.checkNotNull(unit, "unit");

        if (tickDuration <= 0) {
            throw new IllegalArgumentException("tickDuration must be greater than 0(current: " + tickDuration + ")");
        }

        if (ticksPerWheel <= 0) {
            throw new IllegalArgumentException("ticksPerWheel must be greater than 0(current: " + tickDuration + ")");
        }
