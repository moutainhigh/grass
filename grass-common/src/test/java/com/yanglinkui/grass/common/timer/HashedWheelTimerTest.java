...
public class HashedWheelTimerTest {
    ...
    @Test
    @org.junit.jupiter.api.Timeout(value = 3_000, unit = TimeUnit.MILLISECONDS)
    ...
    public void testExecutionOnTime() throws InterruptedException {
        ...
        for (int i = 0; i < scheduledTasks; i++) {
            ...
            assertTrue(delay >= timeout && delay < maxTimeout, "Timeout + " + scheduledTasks + " delay " + delay + " must be " + timeout + " < " + maxTimeout);
        }
